...
class SOLUTION:
    ...
    def Generate_Body(self):
        ...
        pyrosim.Send_Cube(name="BackLeg", pos=[0,-0.5,0] , size=[0.15,1,0.15])
        pyrosim.Send_Cube(name="FrontLeg", pos=[0,0.5,0] , size=[0.15,1,0.15])
        ...
        pyrosim.Send_Cube(name="BackLowerLeg", pos=[0,0,-0.5] , size=[0.15,0.15,1])
        pyrosim.Send_Cube(name="FrontLowerLeg", pos=[0,0,-0.5] , size=[0.15,0.15,1])
    ...
    def Generate_Brain(self): #
        ...
        for currentRow in self.sensorNeurons:
            for currentColumn in self.motorNeurons:
                #print("currentRow= ", currentRow, " - currentColumn= ",currentColumn, " - currentColumn-c.numSensorNeurons-1= ", currentColumn-c.numSensorNeurons)
    ...
    def Wait_For_Simulation_To_End(self, directOrGUI):
        ...
        print("solution - Wait_For_Simulation_To_End() directOrGUI= ", directOrGUI, " - fitnessFileName= ", fitnessFileName)
        
        os.system("ls *fit*.txt")
        ...
        os.system("ls *fit*.txt")
        print("solution - Wait_For_Simulation_To_End() fitnessFileName= ", fitnessFileName)
